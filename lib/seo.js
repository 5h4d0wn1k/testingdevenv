 ...
 */
const DEFAULT_SEO = {
  metaTitle: 'DavCreations - Multi-Vendor E-commerce Platform',
  metaDescription: 'Discover amazing products from multiple vendors on DavCreations. Shop securely with fast delivery and great customer service.',
  metaKeywords: 'ecommerce, online shopping, multi-vendor, marketplace, products',
  ogTitle: 'DavCreations - Multi-Vendor E-commerce Platform',
  ogDescription: 'Discover amazing products from multiple vendors on DavCreations. Shop securely with fast delivery and great customer service.',
...
export async function getSeoSettings() {
  try {
    ...
    return {
      ...
      siteName: settings?.siteName || 'DavCreations',
    };
  } catch (error) {

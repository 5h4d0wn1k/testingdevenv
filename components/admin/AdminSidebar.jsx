...
import { HomeIcon, ShieldCheckIcon, StoreIcon, TicketPercentIcon, PercentIcon, DollarSignIcon, SettingsIcon, PackageIcon, MessageSquareIcon, ClipboardListIcon, BarChart3Icon, FileTextIcon } from "lucide-react"
...
const AdminSidebar = () => {
    ...
    const sidebarLinks = [
        ...
        { name: 'Payouts', href: '/admin/payouts', icon: DollarSignIcon },
        { name: 'Reports', href: '/admin/reports', icon: BarChart3Icon },
        { name: 'Content', href: '/admin/content', icon: FileTextIcon },
        { name: 'Support', href: '/admin/support', icon: MessageSquareIcon },

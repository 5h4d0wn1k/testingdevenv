...
import { getCurrencySymbol } from '@/lib/currency-client';
...
const OrderSummary = ({ totalPrice, items }) => {
    ...
    const settings = useSelector(state => state.settings.publicData)
    const currency = getCurrencySymbol(settings.baseCurrency);

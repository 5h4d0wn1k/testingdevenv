...
import { HomeIcon, LayoutListIcon, SquarePenIcon, SquarePlusIcon, UploadIcon, RotateCcw, DollarSignIcon, BarChart3Icon, Settings } from "lucide-react"
...
const StoreSidebar = ({storeInfo}) => {
    ...
    const sidebarLinks = [
        ...
        ...(storeInfo?.vendorStatus === 'PENDING' ? [{ name: 'Onboarding', href: '/store/onboarding', icon: SquarePlusIcon }] : []),
        { name: 'Profile', href: '/store/profile', icon: SquarePenIcon },
        { name: 'Add Product', href: '/store/add-product', icon: SquarePlusIcon },
        { name: 'Manage Product', href: '/store/manage-product', icon: SquarePenIcon },
        { name: 'Bulk Upload', href: '/store/bulk-upload', icon: UploadIcon },
        { name: 'Orders', href: '/store/orders', icon: LayoutListIcon },
        { name: 'Analytics', href: '/store/analytics', icon: BarChart3Icon },
        { name: 'Financials', href: '/store/financials', icon: DollarSignIcon },
